...
cd /home/vagrant/php-webhook-module
...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "private_network", ip: "192.168.58.40"
  config.vm.provider :parallels do |v|
      v.memory = "4096"
      v.cpus = 2
  end
  config.vm.synced_folder '.', '/home/vagrant/php-webhook-module', disabled: false
